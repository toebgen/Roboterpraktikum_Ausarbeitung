...
%	\item Tiefengenauigkeit: 1mm bei einer Entfernung von 0.5m. Dieser Wert wird größer bei größeren Abständen.  
%%% Quelle: http://ntuzhchen.blogspot.de/2010/12/how-kinect-works-prime-sense.html
%\end{itemize}
%
%Jedes Pixel aus den 640x480 Pixeln enthält eine Tiefeninformation proPixel. Diese Tiefeninformation bewegt sich zwischen 0.5m und 10m mit einer Auflösung von 1cm. der Kinect-Sensor liefert  Pro Sekunde 30 Tiefenbilder.
%
%\subsubsection{Kamerasensor}
%
%Neben dem Tiefensensor besitzt die Kinect eine normale \gls{rgb}-Kamera. Diese hat genauso 640x480 Pixeln.
%
%\subsubsection{Audio}
%
%Der Kinect-Sensor hat 4 Mikrofonen,die eine 3D Lokalisierung ermöglicht.
%
%\subsubsection{Neigesteuerung}
%
%Der 3D-Neigesensor hat die  Aufgabe den Kinect-Sensor durch einen Motor auf der richtige Neigungswinkel zu halten. Der Neigungswinkel liegt zwischen $-31^\circ$und $+30^\circ$ relativ zum Standfuss.
%
