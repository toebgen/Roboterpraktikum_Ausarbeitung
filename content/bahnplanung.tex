...
\begin{itemize}
	...
	\begin{itemize}
		\item Start $(x,y)$, Koordinaten in der Ebene
		\item Following $(x,y,yaw)$, Koordinaten und Orientierung in der Ebene \todoprivate{Skizze zu x-y-z-roll-pitch-yaw ?}
		\item Next $(x,y)$, Koordinaten in der Ebene
	\end{itemize}
