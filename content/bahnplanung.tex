...
\begin{figure}[h]
\center
\includegraphics[scale=0.3]{graphics/A*.png}
...
\todo[inline]{Was es schon gab im Motoransteuerungsteil (aus Odete/segway). SegwayOmniHal Modul gab es schon, wir haben das Modul ergänzt um die plattformspezifische Simulation Segway500RMPSimulation. Eingang sind Geschwindigkeiten und Ausgang sind Plattformspezifische Geschwindigkeiten).
...
\begin{figure}
	\center
	\includegraphics[width=0.4\textwidth]{graphics/roll-pitch-yaw.png}
